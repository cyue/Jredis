...
public class BuilderFactory {
    ...
    /**
     * @author yuecong
     * mixed data type to string_list
     * 
     */
    public static final Builder<List<String>> MIXED_STRING_LIST = new Builder<List<String>>() {
    	@SuppressWarnings("unchecked")
		public List<String> build(Object data) {
    		if(null == data) {
    			return null;
    		...
    		final List<String> result = new ArrayList<String>(l.size());
    		for (Object obj : l) {
    			if (obj instanceof Long) {
    				result.add(Long.toString((Long)obj));
    			}else if (obj instanceof Double) {
    				result.add(Double.toString((Double)obj));
    			}else if (obj instanceof Boolean) {
    				result.add(Boolean.toString((Long)obj == 1));
    			}else {
    				result.add(SafeEncoder.encode((byte[])obj));
    			}
    		}
			return result;
    	}
