...
public class Client extends BinaryClient implements Commands {
    ...
    public void sentinel(String key) {
    	sentinel(SafeEncoder.encode(key));
    }

	public void sentinel(String key, String option) {
		// TODO Auto-generated method stub
		sentinel(SafeEncoder.encode(key), SafeEncoder.encode(option));
	}

	@Override
	public void sentinel(String key, String host, int port) {
		// TODO Auto-generated method stub
		sentinel(SafeEncoder.encode(key), SafeEncoder.encode(host), port);
	}
